          ...
          keymaps = {
            ...
            },
            {
              ...
              keymaps = {
                ...
                {
                  "ŕ<cr>",
                  { n = function() require 'iron'.core.send(nil, string.char(13)) end },
                  description = "Send <cr>",
                },
                {
                  "ŕ<C-C>",
                  { n = function() require 'iron'.core.send(nil, string.char(03)) end },
                  description = "Send ^C",
                },
                {
                  "ŕ<C-D>",
                ...
                {
                  "ŕ<C-L>",
                  { n = function() require 'iron'.core.send(nil, string.char(12))() end },
                  description = "Send ^L",
                },
                {
                  "ĺo",
